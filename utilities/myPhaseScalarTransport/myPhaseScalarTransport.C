...
#include "myPhaseScalarTransport.H"
...
{
    defineTypeNameAndDebug(myPhaseScalarTransport, 0);

    addToRunTimeSelectionTable
    (
        functionObject,
        myPhaseScalarTransport,
        dictionary
    );
}
}
...
Foam::volScalarField& Foam::functionObjects::myPhaseScalarTransport::Phi()
{
    if (!PhiPtr_.valid())
    {
...
Foam::functionObjects::myPhaseScalarTransport::alphaPhi()
{
...
Foam::functionObjects::myPhaseScalarTransport::D
(
...
Foam::functionObjects::myPhaseScalarTransport::myPhaseScalarTransport
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::myPhaseScalarTransport::read(const dictionary& dict)
{
...
bool Foam::functionObjects::myPhaseScalarTransport::execute()
{
...
// // My added coded to avoid spurios blow up
...
bool Foam::functionObjects::myPhaseScalarTransport::write()
{
    return true;
}
